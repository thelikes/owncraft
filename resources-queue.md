...
- [Leveraging Microsoft Teams for Initial Access](https://posts.inthecyber.com/leveraging-microsoft-teams-for-initial-access-42beb07f12c4)
...
- [C-Sto/goWMIExec](https://github.com/C-Sto/goWMIExec)
    ...
    - tags: windows
- [jsecu/BOF-pack-1](https://github.com/jsecu/BOF-pack-1)
...
- [daddycocoaman/azbelt](https://github.com/daddycocoaman/azbelt)
    ...
    - tags: windows, redteam
- [reveng007/SharpGmailC2](https://github.com/reveng007/SharpGmailC2)
    ...
    - tags: redteam
- [icyguider/MoreImpacketExamples](https://github.com/icyguider/MoreImpacketExamples)
    - desc: More examples using the Impacket library designed for learning purposes.
    - tags: windows, pivot
- [elceef/subzuf](https://github.com/elceef/subzuf)
...
- [Hooking System Calls in Windows 11 22H2 like Avast Antivirus. Research, analysis and bypass (the-deniss)](https://the-deniss.github.io/posts/2022/12/08/hooking-system-calls-in-windows-11-22h2-like-avast-antivirus.html)
    ...
    - tags: re, malware
- [Gaining the upper hand(le) - aptw.tf](https://aptw.tf/2022/02/10/leaked-handle-hunting.html)
    - desc: Hunting for privilege escalations and UAC bypasses by looking for leaked handles in unprivileged processes
    - tags: windows, redteam, exploit
- [Electron Shellcode Loader](https://barbellsandrootshells.com/electron-shellcode-loader)
...
- [Modern Initial Access and Evasion Tactics](https://mgeeky.tech/uploads/WarCon22%20-%20Modern%20Initial%20Access%20and%20Evasion%20Tactics.pdf)
    ...
    - tags: phish, redteam
- [Microsoft OneNote (.One File Extension) Attachment Delivers AsyncRAT](https://blog.osarmor.com/319/onenote-attachment-delivers-asyncrat-malware/)
    - desc: OneNote initial access payload research
    - tags: redteam, phish
- [Unicode for Security Professionals - gosecure](https://www.gosecure.net/blog/2020/08/04/unicode-for-security-professionals/)
...
- [daem0nc0re/PrivFu](https://github.com/daem0nc0re/PrivFu)
    ...
    - tags: windows, privesc
- [X-C3LL/FreshyCalls-VBA.vba](https://gist.github.com/X-C3LL/ba905b10163f769061ce619f26c138b8)
...
#### publish
- [On Prem Active Directory - Windows Server 2022 Domain Controller setup - haxor.no](https://haxor.no/en/article/on-prem-active-directory)
    - desc: home lab setup
    - tags: windows, lab
- [GCP Penetration Testing Notes 2 - 0xd4y](https://0xd4y.com/2022/10/24/GCP-Penetration-Testing-Notes-2/)
...
- [mdsecactivebreach/DragonCastle](https://github.com/mdsecactivebreach/DragonCastle)
    ...
    - tags: postex, windows
- [resyncgg/dacquiri](https://github.com/resyncgg/dacquiri)
    - desc: A strong, compile-time enforced authorization framework for rust applications.
    - tags: util
- [anvilsecure/ulexecve](https://github.com/anvilsecure/ulexecve)
...
- [Skidaddle Skideldi - I just pwnd your PKI - lummelsec](https://luemmelsec.github.io/Skidaddle-Skideldi-I-just-pwnd-your-PKI/)
    - desc: ADCS research
    - tags: windows, redteam
...
### tools
- [Synzack/ldapper](https://github.com/Synzack/ldapper)
    - desc: go ldap client
    - tags: util, windows
...
- [Ge0rg3/requests-ip-rotator](https://github.com/Ge0rg3/requests-ip-rotator)
    ...
    - tags: web, recon, util
- [ST1LLY/dc-sonar](https://github.com/ST1LLY/dc-sonar)
...
- [Idov31/Sandman](https://github.com/Idov31/Sandman)
    ...
    - tags: redteam
- [sensepost/impersonate](https://github.com/sensepost/impersonate)
    - desc: A windows token impersonation tool
    - tags: windows, redteam, postex
- [hosch3n/msmap](https://github.com/hosch3n/msmap)
...
### writeups
- [Defeating Javascript Obfuscation - perimeterx](https://www.perimeterx.com/tech-blog/2022/defeating-javascript-obfuscation/)
    - desc: deobfuscate javascript research
    - tags: utility
- [Automating C2 Infrastructure with Terraform, Nebula, Caddy and Cobalt Strike - malicious.group](https://blog.malicious.group/automating-c2-infrastructure-with-terraform-nebula-caddy-and-cobalt-strike/)
    - desc: infrastructure as code research
    - tags: utility, infrastructure
- [Myths About External C2 - xret2pwn](https://xret2pwn.github.io/Myths-About-External-C2/)
...
- [n0kovo/awesome-password-cracking](https://github.com/n0kovo/awesome-password-cracking)
    ...
    - tags: cracking
- [lkarlslund/ldapnomnom](https://github.com/lkarlslund/ldapnomnom)
...
- [Masky release (v0.0.3)](https://z4ksec.github.io/posts/masky-release-v0.0.3/)
    ...
    - tags: windows, redteam
- [In the footsteps of the Fancy Bear: PowerPoint mouse-over event abused to deliver Graphite implants - duskrise](https://blog.cluster25.duskrise.com/2022/09/23/in-the-footsteps-of-the-fancy-bear-powerpoint-graphite/)
    - desc: FancyBear + Powerpoint Mouseover research
    - tags: apt, phish
- [Writing a Beginner's Guide to Sliver Because the Devs Won't - notateamserver](https://notateamserver.xyz/sliver-101/)
...
- [The Blind Spots of BloodHound - syss](https://blog.syss.com/posts/bloodhound-blindspots/)
    ...
    - tags: windows, redteam
- [Certipy 4.0: ESC9 & ESC10, BloodHound GUI, New Authentication and Request Methods — and more! - ifcr](https://research.ifcr.dk/certipy-4-0-esc9-esc10-bloodhound-gui-new-authentication-and-request-methods-and-more-7237d88061f7)
    - desc: Certipy improvements
    - tags: windows, redteam
- [SMTP Matching Abuse in Azure AD - semperis](https://www.semperis.com/blog/smtp-matching-abuse-in-azure-ad/)
    - desc: Azure AD SMTP Abuse research
    - tags: cloud
- [ Automating Cobalt Strike with Python - redxorblue](https://blog.redxorblue.com/2022/06/automating-cobalt-strike-with-python.html)
    - desc: Cobalt Strike automation research
    - tags: redteam, c2

### tools

- [surajpkhetani/Active-Directory-Permission-Abuse](https://github.com/surajpkhetani/Active-Directory-Permission-Abuse)
...
- [Hijacking DLLs in Windows - wietzebeukema](https://www.wietzebeukema.nl/blog/hijacking-dlls-in-windows)
    - desc: Windows DLL hijack research
    - tags: windows, redteam
- [code-scrap/awesome-tunneling](https://github.com/code-scrap/awesome-tunneling)
...
- [Multi-factor Authentication In-The-Wild bypass methods - yuval fischer](https://medium.com/proferosec-osm/multi-factor-authentication-in-the-wild-bypass-methods-689f53f0b62b)
    ...
    - tags: web, exploit
- [Vulnerable GitHub Actions Workflows Part 1: Privilege Escalation Inside Your CI/CD Pipeline - legitsecurity](https://www.legitsecurity.com/blog/github-privilege-escalation-vulnerability)
